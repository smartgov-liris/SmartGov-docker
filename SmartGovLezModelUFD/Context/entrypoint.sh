...
# context...
cd $HOME/SmartGovLezModelUFD/input
...
LEZMODEL+="-jar $HOME/SmartGovLezModelUFD/SmartGovLez-MASTER.jar"
...
CMD_TILE_COMPUTE+="--tile-size 2000 "
...
cp -r $HOME/SmartGovLezModelUFD/output/* /Output/
